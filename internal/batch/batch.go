	...
	sections := []ui.HelpSection{
		{
			...
			Entries: []ui.HelpEntry{
				...
				{Key: "s", Desc: "Scan current folder"},
				{Key: "enter", Desc: "On \"[Scan this folder]\" starts scan"},
			},
		},
		{
			Title: "Results table",
			Entries: []ui.HelpEntry{
				...
				{Key: "enter", Desc: "Open cert details"},
				{Key: "r", Desc: "Sort by days remaining"},
				{Key: "c", Desc: "Sort by CN"},
				{Key: "d", Desc: "Sort by expiry date"},
				{Key: "b", Desc: "Back to folder browser"},
			},
		},
		ui.CommonHelp(),
	}
